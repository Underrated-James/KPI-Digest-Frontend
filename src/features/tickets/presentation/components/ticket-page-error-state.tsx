...
interface TicketPageErrorStateProps {
  error: unknown;
  onRetry: () => void;
}

export function TicketPageErrorState({
  error,
  onRetry,
}: TicketPageErrorStateProps) {
