...
import { pushTeamsUrl } from "../utils/teams-url-state";
...
export function TeamTable({
  ...
  const columns = React.useMemo<ColumnDef<Team>[]>(
    () => [
      {
        id: "select",
        header: ({ table }: { table: TanStackTable<Team> }) => (
          <input
            type="checkbox"
      ...
      ...getTeamColumns({ onEdit, onDelete }),
    ],
    [onDelete, onEdit],
  );
