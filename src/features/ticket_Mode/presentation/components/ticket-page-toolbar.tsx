  ...
  return (
    <div className="rounded-2xl border border-border bg-card/80 p-4 shadow-sm backdrop-blur sm:p-5">
      <div className="flex flex-row flex-wrap items-end gap-4">
        <div className="min-w-[260px] flex-[1.6] space-y-3">
          <label
          ...
          <div className="relative">
            ...
            <Input
              ...
              placeholder={isMobile ? "Search tickets..." : "Search by keyword..."}
              className="h-11 w-full border-border bg-background pl-9 text-foreground placeholder:text-muted-foreground"
            />
          </div>
        </div>
        ...
        <div className="ml-auto flex min-w-[190px] items-end justify-end">
          <Button
            variant="outline"
            className="h-11 w-full cursor-pointer border-destructive/20 text-destructive transition-all duration-200 hover:border-destructive hover:bg-destructive hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
